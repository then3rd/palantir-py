...
#define defaults_h
  ...
  #define DEFAULT_X_MAX_RATE 6000.0 // degrees/min
  #define DEFAULT_Y_MAX_RATE 6000.0
  #define DEFAULT_Z_MAX_RATE 6000.0
  #define DEFAULT_X_ACCELERATION (200.0*60*60) // 200*60*60 = 270000 degrees/min^2 = 200 degrees/sec^2
  #define DEFAULT_Y_ACCELERATION (200.0*60*60)
  #define DEFAULT_Z_ACCELERATION (200.0*60*60)
  #define DEFAULT_X_MAX_TRAVEL 360.0 // degrees
  #define DEFAULT_Y_MAX_TRAVEL 360.0
  #define DEFAULT_Z_MAX_TRAVEL 360.0
